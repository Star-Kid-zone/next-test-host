    ...
    <footer>
      <div className="py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          {/* Top area: Blocks */}
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12" data-aos="fade-right" data-aos-delay="100" data-aos-duration="500">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400" data-aos="fade-right" data-aos-delay="100" data-aos-duration="300">Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.</div>
            </div>
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              {/* 2nd block */}
              <div className="text-sm" data-aos="fade-right" data-aos-delay="200" data-aos-duration="300">
              ...
              {/* 3rd block */}
              <div className="text-sm" data-aos="fade-right" data-aos-delay="300" data-aos-duration="300">
              ...
              {/* 4th block */}
              <div className="text-sm" data-aos="fade-right" data-aos-delay="400" data-aos-duration="300">
